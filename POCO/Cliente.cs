...
namespace POCO
{
    ...
    class Cliente : Persona
    {
        ...
        /// </summary>
        public Cliente(string nombre, string apellido, string correo, string cedula, int genero)
        {
            Nombre = nombre;
            Apellido = apellido;
            Correo = correo;
        ...
        /// </summary>
        public Cliente(string nombre, string apellido, string correo, string cedula, int genero, List<Poliza> polizas, int id)
        {
            ID = id;
            Nombre = nombre;
            Apellido = apellido;
